...
using System.Net;
using ZoomLoop.Api.Features.JsonContents;
...
public class JsonContentController
{
    ...
    private readonly ILogger<JsonContentController> _logger;

    public JsonContentController(IMediator mediator, ILogger<JsonContentController> logger)
    {
